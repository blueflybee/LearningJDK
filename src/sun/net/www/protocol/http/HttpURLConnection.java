...
public class HttpURLConnection extends java.net.HttpURLConnection {
    ...
    */
    ...
    static {
        ...
        userAgent = agent;
        validateProxy = AccessController.doPrivileged(
                new sun.security.action.GetBooleanAction(
                    "http.auth.digest.validateProxy")).booleanValue();
        validateServer = AccessController.doPrivileged(
                new sun.security.action.GetBooleanAction(
                    "http.auth.digest.validateServer")).booleanValue();

        enableESBuffer = AccessController.doPrivileged(
                new sun.security.action.GetBooleanAction(
                    "sun.net.http.errorstream.enableBuffering")).booleanValue();
        timeout4ESBuffer = AccessController.doPrivileged(
                new sun.security.action.GetIntegerAction(
        ...
        bufSize4ES = AccessController.doPrivileged(
                new sun.security.action.GetIntegerAction(
        ...
        allowRestrictedHeaders = AccessController.doPrivileged(
                new sun.security.action.GetBooleanAction(
    ...
    protected HttpURLConnection(URL u, Proxy p, Handler handler) {
        ...
        if (instProxy instanceof sun.net.ApplicationProxy) {
            ...
            cookieHandler = AccessController.doPrivileged(
        ...
        cacheHandler = AccessController.doPrivileged(
    ...
    private IOException getChainedException(final IOException rememberedException) {
        try {
            ...
            IOException chainedException =
                AccessController.doPrivileged(
                    new PrivilegedExceptionAction<IOException>() {
            ...
            if (ret == null) {
                ...
                case BASIC:
                    ...
                    try {
                        ...
                        addr = AccessController.doPrivileged(
    ...
    */
     ...
     * @see #getRequestProperties(String)
     * @since 1.4
     */
    @Override
